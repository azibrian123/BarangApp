        ...
        <div class="col-8">
            ...
            <form action="/barang/update/<?= $barang['id']; ?>" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control <?= ((session('validation') && session('validation')->hasError('nama'))) ? 'is-invalid' : '' ?>" id="nama" name="nama" autofocus value="<?= (old('nama')) ? old('nama') : $barang['nama'] ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <select class="form-select <?= ((session('validation') && session('validation')->hasError('klasifikasi'))) ? 'is-invalid' : '' ?>" aria-label="Default select example" name="klasifikasi">
                            <option selected value="<?= $barang['klasifikasiid'] ?>"><?= $barang['klasifikasinama']; ?></option>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control <?= ((session('validation') && session('validation')->hasError('jumlah'))) ? 'is-invalid' : '' ?>" id="jumlah" name="jumlah" autofocus value="<?= (old('jumlah')) ? old('jumlah') : $barang['jumlah'] ?>" min="0">
                        <div id="validationServer03Feedback" class="invalid-feedback">
                            <?php if (session('validation')) : ?>
